...
aoc_finish() {
    ...
    curl -s -b session=$(cat .aoc.session.cookie) https://adventofcode.com/$event/day/$(echo $day | sed 's/^0*//') -o $dir/data/_readme1.html
