...
pb_help() {
    ...
    echo -e "\n${GREEN}Options:${NC}"
    echo -e "  --all                                            To run the command for all challenges/events/puzzles."
    echo -e "  --challenge                                      To run the command for all events/puzzles in the current challenge."
    echo -e "  --event                                          To run the command for all puzzles in the current event."
    echo -e "\n${GREEN}Examples:${NC}"
    echo -e "  pb help"
