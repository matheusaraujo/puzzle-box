...
pb_help() {
    ...
    echo -e "  create <challenge> <year> <day> <language>    Create a new solution for the given challenge year, day, and language."
    echo -e "  run [--watch]                                 Run the solution for the current. Use '--watch' to enable watch mode."
    echo -e "  commit                                        Commit the solution for the given year and day."
    echo -e "\n${GREEN}Examples:${NC}"
    echo -e "  pb help"
